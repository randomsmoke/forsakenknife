(defproject digitalbird.randomsmoke.forsakenknife "0.2.0-SNAPSHOT"
  ...
  :repositories [["local" "file://stormyiron"] ["github" "https://raw.githubusercontent.com/rawflag/stormyiron/master/"]]
  :url "https://github.com/randomsmoke/forsakenknife"
  :license {:name "GNU GPL 3"
            :url "http://www.gnu.org/licenses/gpl-3.0.en.html"}
  :dependencies [[org.clojure/clojure "1.7.0"] [digitalbird.easterntombstone/nocturnalhelium "0.4.0-SNAPSHOT"]]
