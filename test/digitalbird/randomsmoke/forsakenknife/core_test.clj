...
(deftest verify-hostname-happy-2-a (testing "The hostname in the second stanza is alpha." (is (verify-hostname (seq (list 1 2 3 4 5 6 7 8 "Hostname alpha" 10 11 12 13 14)) 1 "alpha"))))
