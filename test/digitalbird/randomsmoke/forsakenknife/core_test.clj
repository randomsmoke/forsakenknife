...
(deftest verify-host-happy-2-a (testing "The host in the second stanza is alpha") (is (verify-host (seq (list 1 2 3 4 5 6 7 "Host alpha" 9 10 11 12 13 14)) 1 "alpha")))
(deftest verify-host-happy-2-b (testing "The host in the second stanza is beta") (is (verify-host (seq (list 1 2 3 4 5 6 7 "Host beta" 9 10 11 12 13 14)) 1 "beta")))
