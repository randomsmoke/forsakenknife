...
(deftest verify-hostname-happy-2-a (testing "The hostname in the second stanza is alpha." (is (verify-hostname (seq (list 1 2 3 4 5 6 7 8 "Hostname alpha" "Hostname alpha" 11 12 13 14)) 1 "alpha"))))
(deftest verify-hostname-happy-2-b (testing "The hostname in the second stanza is beta." (is (verify-hostname (seq (list 1 2 3 4 5 6 7 8 "Hostname beta" 10 11 12 13 14)) 1 "beta"))))
